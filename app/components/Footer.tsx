  ...
  return (
    <>
      ...
      >
        <div
          className={`${
            pathnameUrl === "/explore" ? "text-nesstDarkGrey" : "text-gray-400"
          } `}
        >
        ...
        <div className="relative self-end">
          ...
          />
          <p className="text-sm text-nesstLightGrey">NESST</p>
        </div>

        <div
          className={`${
            pathnameUrl === "/messages" ? "text-nesstDarkGrey" : "text-gray-400"
          } `}
        >
        ...
        <div
          className={`${
            pathnameUrl === "/profile" ? "text-nesstDarkGrey" : "text-gray-400"
          } `}
        >
