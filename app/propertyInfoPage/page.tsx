...
<p className="font-medium">{clickedProperty.available ?
...
<p className="font-medium">
  {clickedProperty.Kitchen ? ( <svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
