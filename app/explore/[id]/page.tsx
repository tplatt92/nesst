  ...
  return (
    ...
    <p className="text-gray-400 ">
          ...
          <article className="grid grid-cols-2 gap-4 p-2">
            ...
            <p className="font-medium">{property.TV ? (<svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M19.862 31.5215H25.793V33.4985H19.862V31.5215ZM15.908 33.4985V35.4755H29.747V33.4985H27.77V31.5215L28.8402 31.5175L29.0551 31.5123C31.6858 31.4002 31.5421 30.3182 28.8837 30.3182L16.4787 30.3274C13.848 30.4394 13.9903 31.5215 16.6487 31.5215H17.885V33.4985H15.908Z" fill="#3C3C3C"/>
<path d="M12.9425 11.7515H32.7125L32.8865 11.7568C34.443 11.8464 35.678 13.138 35.678 14.717V26.579L35.6727 26.753C35.5831 28.3095 34.2915 29.5445 32.7125 29.5445H12.9425L12.7685 29.5392C11.212 29.4496 9.977 28.158 9.977 26.579V14.717L9.98227 14.543C10.0719 12.9865 11.3635 11.7515 12.9425 11.7515ZM27.77 31.5215H32.7125L32.9273 31.5175C35.5581 31.4055 37.655 29.2374 37.655 26.579V14.717L37.651 14.5022C37.539 11.8714 35.3709 9.7745 32.7125 9.7745H12.9425L12.7277 9.77845C10.0969 9.89048 8 12.0586 8 14.717V26.579L8.00395 26.7938C8.11598 29.4246 10.2841 31.5215 12.9425 31.5215H17.885H27.77Z" fill="#3C3C3C"/>
</svg>
): null}{property.TV ? "TV" : null}</p>
            <p className="font-medium">{property.Desk ? (<svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>): null} {property.Desk ? "Desk" : null}</p>
            <p className="font-medium">{property.Washer ? (<svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_2_1380)">
<path d="M55.8141 59.875C55.8141 57.151 55.8141 54.415 55.8141 51.604C55.8141 48.793 55.8141 45.905 55.8141 42.875C55.8141 39.78 56.2261 35.917 56.4321 32.509C56.6381 29.101 56.6371 26.149 55.8141 24.875C55.7481 24.774 55.0751 24.774 54.3791 24.799C53.6841 24.824 52.9661 24.875 52.8141 24.875C48.7041 24.875 48.0151 23.171 45.8141 21.875C43.4831 20.502 42.6641 19.829 39.8141 19.875C33.9331 19.97 31.5791 24.976 26.8141 24.875C21.9711 24.773 18.1401 18.732 13.8141 18.875C9.89213 19.005 6.18913 24.852 1.81413 24.875C-3.36788 24.903 -5.94787 18.856 -10.1859 20.875C-8.45887 34.259 -12.6889 46.588 -10.1859 52.875C-9.66587 54.181 -6.97687 55.681 -5.18587 56.875C-2.65987 58.56 -0.798875 59.883 1.81413 59.875C6.42513 59.861 9.37113 53.817 14.8141 53.875C18.6921 53.916 23.3351 59.983 27.8141 59.875C33.1761 59.745 34.9671 53.69 40.8141 53.875C46.4791 54.055 48.5351 61.867 55.8141 59.875Z" stroke="#3C3C3C" stroke-width="2"/>
<path d="M10.8141 9.875H34.8141C35.3661 9.875 35.8141 10.323 35.8141 10.875V34.875C35.8141 35.427 35.3661 35.875 34.8141 35.875H10.8141C10.2621 35.875 9.81415 35.427 9.81415 34.875V10.875C9.81415 10.323 10.2621 9.875 10.8141 9.875Z" stroke="#3C3C3C" stroke-width="2"/>
<path d="M22.8141 14.875C27.2321 14.875 30.8141 18.457 30.8141 22.875C30.8141 27.293 27.2321 30.875 22.8141 30.875C18.3961 30.875 14.8141 27.293 14.8141 22.875C14.8141 18.457 18.3961 14.875 22.8141 14.875Z" stroke="#3C3C3C" stroke-width="2"/>
<path d="M13.8141 12.875C14.3661 12.875 14.8141 13.323 14.8141 13.875C14.8141 14.427 14.3661 14.875 13.8141 14.875C13.2621 14.875 12.8141 14.427 12.8141 13.875C12.8141 13.323 13.2621 12.875 13.8141 12.875Z" fill="#3C3C3C"/>
</g>
<defs>
...
): null}{property.Washer ? "Washer" : null}</p>
            <p className="font-medium">{property.SmokeAlarm ? (<svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M23 8.75C30.732 8.75 37 15.018 37 22.75C37 30.482 30.732 36.75 23 36.75C15.268 36.75 9 30.482 9 22.75C9 15.018 15.268 8.75 23 8.75Z" stroke="#3C3C3C" strokeWidth="2"/>
...
<path d="M23 20.75C24.105 20.75 25 21.645 25 22.75C25 23.855 24.105 24.75 23 24.75C21.895 24.75 21 23.855 21 22.75C21 21.645 21.895 20.75 23 20.75Z" stroke="#3C3C3C" strokeWidth="2"/>
</svg>
): null}{property.SmokeAlarm ? "Smoke Alarm" : null}</p>
            ...
            <p className="font-medium">
              ...
              ) : null}{property.Aircon ? "Aircon" : null}
            </p>
            <p className="font-medium">
              {property.Kitchen ? (
                <svg
              ...
              ) : null}{property.Kitchen ? "Kitchen" : null}
            </p>
            <p className="font-medium">
              {property.Parking ? (
                <svg
              ...
              ) : null}{property.Parking ? "Parking" : null}
            </p>
          </article>
        </Card>
      ))}
