      ...
      <main className="px-4 pt-4 pb-32">
        ...
        {properties?.map((property) => (
          <Card key={property.id}>
            ...
            <div>
              <CardContent className="md:grid md:grid-cols-2  md:grid-rows-2 md:border-b">
                <div>
                ...
                <div>
                  ...
                  <article className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 place-items-center gap-4 p-4 text-xs">
                    {property.TV ? (
